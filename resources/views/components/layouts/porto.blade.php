			...
			<header class="header">
				...
				<div class="header-right">
					...
					<form action="#" method="GET" class="search nav-form">
						<div class="input-group">
							<input type="text" class="form-control" name="search" id="search" placeholder="Search for scripts">
							<button class="btn btn-default" type="submit"><i class="bx bx-search"></i></button>
						</div>
					</form>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-bs-toggle="dropdown">
							...
							<figure class="profile-picture">
								<img src="{{ $profile_image ? asset('images/profiles/' . $profile_image) : asset('img/!logged-user.jpg') }}" class="rounded img-fluid">
							</figure>
